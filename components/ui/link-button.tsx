...
const linkButtonVariants = cva(
  "cursor-pointer inline-flex items-center justify-center font-[16px] capitalize",
  {
    variants: {
      variant: {
        primary: "px-[80px] py-2 rounded-none border border-foreground/80 bg-white/80 text-black hover:text-foreground/80 hover:bg-black duration-300",
        secondary:
...
export const LinkButton: React.FC<LinkButtonProps> = ({ label, link, icon, iconPosition, className, iconWrapperClassName}: LinkButtonProps) => {
    return (
